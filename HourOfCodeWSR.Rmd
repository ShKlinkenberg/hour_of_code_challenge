...
We have been talking about validity and reliability. Try to code the image below and make it so that you can modify the amount of [precision and accuracy](https://en.wikipedia.org/wiki/Accuracy_and_precision) You don't have to animate it. 
